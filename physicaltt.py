...
logger = CSVLogger(save_dir='/home/igardner/newresults/', name='physical1logs')
# training loop
checkpoint_callback2 = ModelCheckpoint(
    ...
    every_n_epochs=10,
    mode="max",
    dirpath="/home/igardner/newresults/physical1logs/",
    filename="bb",
)
...
trainer.test(model=physical1model, dataloaders=test_loader, verbose=True, ckpt_path="/home/igardner/newresults/physical1logs/bb.ckpt")
...
dataframe.to_csv("/home/igardner/newresults/physical1logs/testclassificationreport.csv")
